...
const AddCourtModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 rounded-xl max-w-md w-full max-h-[80vh] overflow-y-auto border border-slate-700">
        <div className="sticky top-0 bg-slate-800 border-b border-slate-700 p-4 flex items-center justify-between rounded-t-xl">
          <h2 className="text-xl font-bold text-white">Add New Court</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Unavailable" className="bg-slate-700">Unavailable</option>
              <option value="Maintenance" className="bg-slate-700">Maintenance</option>
            </select>
          </div>
